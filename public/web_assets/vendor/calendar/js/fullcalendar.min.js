...
!function (t) {
    ...
    function bt(e, n) {
        ...
        function o(i) {
            var r = e.theme, s = t('<div class="fc-' + i + '"/>'), o = n.layout[i], a = e.opt("customButtons") || {},
                l = e.overrides.buttonText || {}, u = e.opt("buttonText") || {};
    ...
    var Wt = t.fullCalendar = {version: "3.6.0", internalApiVersion: 11}, _t = Wt.views = {};
    ...
    te.push("_fullCalendar"), te.push("_ambigTime"), te.push("_ambigZone"), Wt.moment = function () {
        ...
        function i(t, e, n, i, r) {
            var s, o, a, l = t.sameUnits, u = e.clone().stripZone(), c = n.clone().stripZone(),
                f = h(t.fakeFormatString, e), g = h(t.fakeFormatString, n), p = "", v = "", m = "", y = "", w = "";
    ...
    var De = dt.extend({
        ...
        eventPointing: null, dragListener: null, isDragging: !1, constructor: function (t, e) {
            ...
            var e, n, i, r = this, a = this.component, l = this.view, u = l.calendar, c = u.eventManager, h = t.el,
                d = t.footprint.eventDef, f = t.footprint.eventInstance;
            if (this.dragListener) return this.dragListener;
            var g = this.dragListener = new ve(l, {
                scroll: this.opt("dragScroll"), subjectEl: h, subjectCenter: !0, interactionStart: function (i) {
    ...
    var Te = Wt.EventPointing = De.extend({
        ...
        eventFootprintToSegs: function (t, e) {
            var n, i, r, s = t.componentFootprint.unzonedRange;
            for (e && (s = s.intersect(e)), n = this.componentFootprintToSegs(t.componentFootprint), i = 0; i < n.length; i++) r = n[i], s.isStart || (r.isStart = !1), s.isEnd || (r.isEnd = !1), r.footprint = t;
            return n
        },
    ...
    var ke = Wt.InteractiveDateComponent = Fe.extend({
        ...
        sliceRangeByRow: function (t) {
            var e, n, i, r, s, o = this.daysPerRow, a = this.view.computeDayRange(t), l = this.getDateDayIndex(a.start),
                u = this.getDateDayIndex(a.end.clone().subtract(1, "days")), c = [];
        ...
        sliceRangeByDay: function (t) {
            var e, n, i, r, s, o, a = this.daysPerRow, l = this.view.computeDayRange(t),
                u = this.getDateDayIndex(l.start), c = this.getDateDayIndex(l.end.clone().subtract(1, "days")), h = [];
        ...
        renderHeadDateCellHtml: function (t, e, n) {
            var i = this.view, r = this.dateProfile.activeUnzonedRange.containsDate(t),
                s = ["fc-day-header", i.calendar.theme.getClass("widgetHeader")], o = et(t.format(this.colHeadFormat));
        ...
        renderBgCellHtml: function (t, e) {
            var n = this.view, i = this.dateProfile.activeUnzonedRange.containsDate(t), r = this.getDayClasses(t);
        ...
        triggerExternalDrop: function (t, e, n, i, r) {
            ...
            }), e && this.publiclyTrigger("eventReceive", {context: this, args: [t.buildInstance().toLegacy(), this]})
        },
    ...
    Ae.watch("displayingDates", ["isInDom", "dateProfile"], function (t) {
        ...
        buildPrevDateProfile: function (t) {
            var e = this.get("dateProfile"), n = t.clone().startOf(e.currentRangeUnit).subtract(e.dateIncrement);
    ...
    Le.mixin({
        ...
        initialRender: function () {
            ...
            n.addClass("fc"), n.on("click.fc", "a[data-goto]", function (n) {
                ...
                var i = hn.getThemeClass(t.themeSystem || t.theme), r = new i(e.optionsModel), s = r.getClass("widget");
        ...
        var e, n = this.eventManager.getEventInstances(), i = n.map(Pt), r = this.eventRangesToEventFootprints(i);
    ...
    var Ue = Wt.UnzonedRange = dt.extend({
        ...
        addEventDef: function (t) {
            var e, n = this.eventDefsById, i = t.id, r = n[i] || (n[i] = []), s = t.buildInstances(this.unzonedRange);
    ...
    var Ye = {start: "09:00", end: "17:00", dow: [1, 2, 3, 4, 5], rendering: "inverse-background"},
        je = Wt.BusinessHourGenerator = dt.extend({
            rawComplexDef: null, calendar: null, constructor: function (t, e) {
    ...
    tn.isStandardProp = function (t) {
        ...
        if (!n) return !1;
        var r = e.calendar, s = r.moment(n), o = i ? r.moment(i) : null, a = t.allDay, l = r.opt("forceEventDuration");
    ...
    var en = dt.extend({
        unzonedRange: null, eventDef: null, eventInstance: null, constructor: function (t, e, n) {
    ...
    sn.createFromDiff = function (t, e, n) {
        ...
        var r, s, o, a, l = t.end && !e.end, u = t.isAllDay() && !e.isAllDay(), c = !t.isAllDay() && e.isAllDay();
    ...
    var cn = on.extend({
        ...
        fetch: function (e, n, i) {
            var r = this, s = this.ajaxSettings, o = s.success, a = s.error, l = this.buildRequestParams(e, n, i);
            return this.calendar.pushLoading(), ce.construct(function (e, n) {
                t.ajax(t.extend({url: this.url}, cn.AJAX_DEFAULTS, s, {
                    data: l, success: function (i) {
                        var s;
    ...
    var vn = xe.extend({
        ...
        dayGrid: null, rowStructs: null, constructor: function (t) {
            ...
            var r, s, o, a, l, u, c, h = this.dayGrid.colCnt, d = this.buildSegLevels(n), f = Math.max(1, d.length),
                g = t("<tbody/>"), p = [], v = [], m = [];
            for (r = 0; r < f; r++) {
    ...
    wn.mixin({
        segPopover: null, popoverSegs: null, removeSegPopover: function () {
            ...
            var i, r, s, o = this.rowEls.eq(e), a = o.height(), l = this.eventRenderer.rowStructs[e].tbodyEl.children();
            ...
            var r, s, o, a, l, u, c, h, d, f, g, p, v, m, y, w = this, D = this.eventRenderer.rowStructs[e], b = [],
                E = 0;
            ...
            var r, s = this.view, o = s.calendar.theme, a = this.getCellDate(e, n).format(this.opt("dayPopoverFormat")),
            ...
            var n, i = e.clone(), r = i.clone().add(1, "days"), s = new Ue(i, r), o = [];
            for (n = 0; n < t.length; n++) o.push.apply(o, this.eventFootprintToSegs(t[n].footprint, s));
            return this.eventRenderer.sortEventSegs(o), o
    ...
    var Dn = Wt.BasicView = Ae.extend({
        scroller: null, dayGridClass: wn, dayGrid: null, weekNumberWidth: null, constructor: function () {
            ...
            var i = Ae.prototype.buildRenderRange.apply(this, arguments), r = this.calendar.msToUtcMoment(i.startMs, n),
    ...
    }, _t.agendaDay = {type: "agenda", duration: {days: 1}}, _t.agendaWeek = {type: "agenda", duration: {weeks: 1}};
    ...
    }, _t.listDay = {type: "list", duration: {days: 1}, defaults: {listDayFormat: "dddd"}}, _t.listWeek = {
        type: "list",
        duration: {weeks: 1},
