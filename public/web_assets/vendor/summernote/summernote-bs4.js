...
var toolbar = renderer.create('<div class="note-toolbar-wrapper"><div class="note-toolbar" role="toolbar"></div></div>');
...
var ui = {
	...
	button: function ($node, options) {
		return renderer.create('<button type="button" class="note-btn btn btn-sm" role="button" tabindex="-1">', function ($node, options) {
				...
				children: [
					...
					_this.ui.dropdown({
						items: [
							...
							'  <div>',
							'    <button type="button" class="note-color-reset btn btn-white" data-event="backColor" data-value="inherit">',
							...
							'  <div>',
							'    <button type="button" class="note-color-reset btn btn-white" data-event="removeFormat" data-value="foreColor">',
